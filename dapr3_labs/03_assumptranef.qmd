...
__Hints:__  
  ...
  - Use `hist()` if you like, or `qqmath()` from the __lattice__ package. 
...
`r qbegin("10")`
Using a method of your choosing, conduct inferences from your final model and write up the results. 
`r qend()`
`r solbegin(show=params$SHOW_SOLS, toggle=params$TOGGLE)`
