...
This design is an intervention study - i.e. where the researcher _intervenes_ (e.g. through administration of a drug or treatment). It is also longitudinal in the sense that it has measured the same thing across time.  
