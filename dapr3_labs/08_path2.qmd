...
#| label: fig-medpath1
#| echo: false
#| fig-cap: "Mediation as a path model (If you're interested, you can find the inspiration for this data from the paper [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7596314/). I haven't properly read it though!)"
#| out-height: "300px"
