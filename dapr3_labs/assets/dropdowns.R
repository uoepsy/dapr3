    ...
    if(show){
        if (knitr::is_html_output()) {
            ...
            part1 <- paste0("<div class=\"solution-begin\">",
                            ifelse(toggle, sprintf("<span id='%s' class=\"fa fa-hand-o-right solution-icon clickable\" onclick=\"toggle_visibility('%s', '%s')\">  %s</span>",id1, id2, id1, slab),""),
                            "</div>",
    ...
    if(show){
        if (knitr::is_html_output()) {
            ...
            part1 <- paste0("<div class=\"optional-begin\">",
                            ifelse(toggle, sprintf("<span id='%s' class=\"fa fa-hand-o-right optional-icon clickable\" onclick=\"toggle_visibility('%s', '%s')\"> <span class=\"olab\">%s</span></span>",id1, id2, id1, olab),""),
                            "</div>",
