...
broom.mixed::tidy(hangrywb,effects="fixed") |>
  transmute(
    ...
    interpretation=c(
      "estimated irritability score for someone with an average hunger of 0, at a time when they are at that average",
      "estimated difference in irritability between two people who differ in average hunger level by 1 (e.g., a person with average hunger of 11 vs someone with average hunger level of 10), at times when they are at their averages",
      "estimated change in irritability score for every 1 more hungry than usual a person is"
    )
  ) |> gt::gt()
```
...
broom.mixed::tidy(hangrywb,effects="ran_pars") |>
  ...
  transmute(
    term,est=round(estimate,3),
    interpretation=c(
      "Participant level variability in irritability when they are at their average hunger level - i.e. at a time when everybody is at their own average level of hunger, they vary in their irritability scores with a standard deviation of 7.",
