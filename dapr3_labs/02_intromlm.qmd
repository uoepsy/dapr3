...
<br>
<br>
Match the coloured sections Red, Orange, Yellow and Blue in @fig-lmersummap to the descriptions below of @fig-modfit A through D. 
...
_If you get an error about model convergence, consider changing the optimiser (see the "estimation" box [above](02_intromlm.html#model-estimation))_
...
summary(m.null)
```
We can see the `4.76 / (4.76 + 22.48)`, or `r (4.76 / (4.76 + 22.48)) %>% round(.,2)` of the total variance is attributable to participant-level variation. 
