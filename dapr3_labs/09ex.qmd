...
Are the loadings all "big enough"? Think back to 'salient' being defined as $>|0.3|$ in EFA - these were standardised loadings (where everything - both latent variables and observed variables - is standardised).  
...
Be aware, however, that depending on how you have scaled the latent variable, the significance tests might be more or less meaningful.  
