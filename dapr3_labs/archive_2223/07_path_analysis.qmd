...
```{r fig-path1nopath, out.width="350px", echo=FALSE,fig.cap="My variables"}
...
```{r fig-path1path, out.width="350px", echo=FALSE,fig.cap="My theory about my system of variables"}
