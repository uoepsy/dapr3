---
title: "Introducing Multi Level Models"
...
:::statbox
To read about the subtle difference between "likelihood" and "probability", you can find a short explanation at https://uoepsy.github.io/lvp.html TODO 
:::
...
```{r echo=FALSE}
library(pbkrtest)
res <- PBmodcomp(m.base, m.null)
res
```

:::int

Parameetric Bootstrap Likelihood Ratio test found that the inclusion of Assessment significantly improved model fit over the null model ( $\chi^2(1)$ = `r round(res$test$stat[2],2)`, `r ifelse(res$test$p.value[2]<.001, "p < .001", paste0("p = ",round(res$test$p.value[2], 3)))`), suggesting that participants' weights changed over course of 36 month assessment period. 
