...
- `visit`: We see a negative association between `visit` and `GAD`: the more therapy visits you have, the less your anxiety.
...
I doubt we can reject the null hypothesis that, on average, there's no difference between the treatment and control groups.
