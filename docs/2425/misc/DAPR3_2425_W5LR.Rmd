...
# data
load("dapr3_liveR_newtricks.RData")
...
averaged across dogs, it took `r res[1,"est"]` seconds to complete the trick on the first day of training (b = `r res[1,"est"]`, t(`r res[1,"df"]`)=`r res[1,"t"]`, p `r res[1,"p"]`). For puppies, each subsequent day of training was associated with a `r res[2,"est"]` decrease in time taken ()
