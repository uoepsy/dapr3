...
- [EXAMPLE]
- and this is really just an interaction, but one effect is at school level, and the other is at child level
...
- ask questions about correlations between random effects
- do groups that have have higher (relative to other groups) intercepts, show greater effects of X?  
