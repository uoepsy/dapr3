---
title: "<b>Course Introduction 2023/24</b>"
...
- Multilevel/Mixed effect Linear Models
- Assumptions, Diagnostics, Centering  
- Random Effect Structures  
- Getting from Questions to Models  
...
---
# Assessments: Quizzes (10% of final grade)
...
*Note that while you can submit until Sunday at 5pm, there will be no tech support available over the weekend from staff.*




---
# Assessments: Report (30% of final grade)


- Based on content from Block 1 of the course (weeks 1-5)
  + check a dataset for consistency
  + explore and test hypotheses about how variables are related
...
.br3.center.bg-green.white.f3[
Released 19th October at 12 Noon, Due 9th November at 12 Noon
]


---
# Assessments: Exam (60% of final grade)
...
- You will be given an equation sheet in the exam. _unlike DAPR2, you may **not** take notes into the exam_.  
]
.pull-right[

- Section A: 15 multiple choice questions
- Section B: 10 written answer questions
  - some ask you to explain statistical concepts discussed in the course
  - some give you a research design and question and task you with specifying an appropriate model  
  - some give you model output and ask you to provide interpretation  
  - questions range from 4 to 20 marks.  

]


.br3.center.bg-green.white.f3[
We will devote some time in a later lecture about exam preparation/time management etc.<br>We will provide example questions.]
...
.flex.items-center[.w-80[__Please install a version of R and RStudio on your own computer.__<br>__Please update any existing installations__<br>For update/installation instructions, see https://edin.ac/3B0oi5A<br>_please read these carefully_<br><br>_For those of you who have chromebooks, installing R & RStudio is not an option, and you may continue to use the PPLS RStudio Server. However, this has been reset, so please request access via this form: https://edin.ac/3Le1mEW _].w-50[![:scale 70%](jk_img_sandbox/qrinstall.svg)]]
