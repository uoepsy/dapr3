...
$$
\begin{align}
\text{outcome} &= \text{model} &+ \quad \text{error} \\
\quad \\
\text{observed correlation matrix} & = 
\begin{aligned}[c] &\text{factor loadings} \\ &\text{(maybe rotated)} \end{aligned} &+\quad \text{unique variance} \\
\end{align}
$$
...
\text{outcome} &= \text{model} &+ \text{error} \\
\quad \\
\text{observed covariance matrix} & = \text{model parameters} &+ \text{unique variance} \\
\quad \\
&... \\
&... \\
&... \\
\quad \\
\text{observed covariance matrix} & = \text{model implied covariance matrix} &+ \text{unique variance} \\
\end{align}
$$
