...
![](img_sandbox/duck.jpg){width=400}

## Nested Structures (2)

The things in a cluster belong __only__ to that cluster.  

![](img_sandbox/structure_nestednew.png){width=100% fig-align="center"}

:::{.fragment}
![](img_sandbox/tables-nested2.svg){width=500 fig-align="center"}
:::
...
![](img_sandbox/structure_nestedlabnew.png){width=100% fig-align="center"}

![](img_sandbox/tables-nested.svg){width=500 fig-align="center"}
...
![](img_sandbox/structure_crossednew.png){width=100% fig-align="center"}

:::{.fragment}
![](img_sandbox/tables-crossed2.svg){width=450 fig-align="center"}
:::
...
![](img_sandbox/tables-crossed3.svg){width=450 fig-align="center"}
...
![](img_sandbox/tables-crossed.svg){width=600 fig-align="center"}
...
```{r}
#| include: false
df <- read_csv("https://uoepsy.github.io/data/lmm_egcross1.csv") |> mutate(across(c(condition,group,ppt), factor))
```
...
```{r}
#| include: false
df <- read_csv("https://uoepsy.github.io/data/lmm_egcross2.csv") |> mutate(across(c(condition,group,ppt), factor))
```
...
:::{.column width="60%"}
```{r}
mydata = read_csv("https://uoepsy.github.io/data/lmmpcademo.csv") |> mutate(
  hospital = gl(4,100),
  patient = g,
  dosage = x1,
  length_stay = x3,
