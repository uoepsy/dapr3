...
_For those of you who have chromebooks, installing R & RStudio is not an option, and you may continue to use the PPLS RStudio Server. However, this has been reset, so please request access via this form: [https://edin.ac/3Le1mEW](https://edin.ac/3Le1mEW){target="_blank"}_
