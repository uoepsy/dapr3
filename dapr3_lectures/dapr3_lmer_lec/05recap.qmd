...
- often it's about the amount of variability relative to the corresponding fixed effect.         - a fixed slope of 0.5 with groups varying in slopes with an SD of 1
...
Lots of options to customise tables:  
```{r eval=FALSE}
library(sjPlot)
tab_model(absmod, 
          show.ci = 0.95,
