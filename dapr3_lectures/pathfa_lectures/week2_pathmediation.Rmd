...
.pull-right[
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram basic.png")
```
]
...
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram basic indirect.png")
```
...
.pull-right[
```{r, echo=FALSE}
knitr::include_graphics("trad med.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram example.png")
```
...
.pull-right[
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram example a b.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram example a b c.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("med reporting.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("Mediation diagram example multiple mediation.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("med versus confounding.png")
```
