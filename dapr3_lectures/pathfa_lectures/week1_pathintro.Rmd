...
3. Endogenous variable rsiduals **do not correlate** with exogenous variables.
...
- There are three levels of identification:
  ...
  - **Just Identified** models: have 0 degrees of freedom (all standard linear models are just indentified)
...
- For ease, we will note a small number, and focus on the suggested values that indicate good vs bad fit.
  ...
  - Model fit is a continum and the use of fit indices much debated.
