...
4. Extract PCS scores from analyses in R
...
<h2 style="text-align: left;opacity:0.3;">Part 3: Estimation and Interpretation</h2>
<h2 style="text-align: left;opacity:0.3;">Part 4: PCA scores & an example</h2>
---
...
<h2 style="text-align: left;opacity:0.3;">Part 1: Introduction to data reduction</h2>
<h2 style="text-align: left;opacity:0.3;">Part 2: Purpose of PCA</h2>
<h2>Part 3: Estimation and Interpretation</h2>
<h2 style="text-align: left;opacity:0.3;">Part 4: PCA scores & an example</h2>
...
<h2 style="text-align: left;opacity:0.3;">Part 2: Purpose of PCA</h2>
<h2 style="text-align: left;opacity:0.3;">Part 3: Estimation and Interpretation</h2>
<h2>Part 4: PCA scores & an example</h2>
