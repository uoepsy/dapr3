...
:::{.dapr3callout .fragment}
4. Refer back to all predictors you identified in Step 1. For each randomly-varying grouping variable, check whether at least some of its levels appear with more than one value of each predictor (i.e., whether the predictor varies within each level of the grouping variable).
