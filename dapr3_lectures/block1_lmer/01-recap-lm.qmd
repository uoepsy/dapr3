...
:::dapr3callout
How do we identify grouping structure in a tidy dataset?

<!-- - We look for categorical variables whose values appear more than once. -->
:::
...
In this week's lab, you'll have a chance to practice it on ten different datasets.
...
```{r wooplots, fig.height = 8, fig.width = 10, echo=F, fig.align = "center"}
p1 <- ggplot() +
