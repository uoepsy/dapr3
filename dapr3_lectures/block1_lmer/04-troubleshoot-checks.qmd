...
| If predictors `x` and `z` are continuous, remove the correlations between by-group adjustments (if predictors are categorical, other weird stuff happens and this step doesn't really simplify anything). | `y ~ x * z + (1 + x + z || g)` |
...
:::fragment
![](figs/w4-troubleshoot-solutions5.svg){fig-align="center" height=450px}
:::
