...
For categorical or ordinal predictors that have more than one level, how many times does each level appear?

<!-- What grouping variable(s) does this dataset contain? -->
<!-- How many levels/different values does each grouping variable have? (If the answer is 1, then it's not a grouping variable.) -->


We'll use R code to count for us.
