...
<!-- - adjustments to a linear model's intercept for each level of a grouping variable -->
:::

:::{.dapr3callout .fragment}
What are random slopes?

<!-- - adjustments to a linear model's slope for each level of a grouping variable -->
:::
...
<!-- - in general, a way for models to estimate how different levels of a grouping variable diverge from the average effect in the data -->
:::

:::{.dapr3callout .fragment}
What are fixed effects?

<!-- - the coefficients (intercept and slopes) of a linear mixed model, which represent the average effects across the whole dataset -->
:::
