...
- Still an underlying "dimension", but.. 
...
- As EFA is a model, just like linear models and other statistical tools, using it requires us to make some assumptions:
    ...
    1.  The error terms should be uncorrelated
    2.  The residuals/errors should not correlate with the factor
...
# Suitability of data, factor extraction methods {background-color="white"}
