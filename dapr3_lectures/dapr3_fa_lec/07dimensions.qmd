...
#| eval: false
library(psych)
principal(lifesat_data, nfactors = 6, rotate = "none")  
```
...
```{r}
fa.parallel(lifesat_data, fa = "pc", n.iter = 500)
```
...
mypca <- principal(lifesat_data, nfactors = 1, rotate = "none")  
