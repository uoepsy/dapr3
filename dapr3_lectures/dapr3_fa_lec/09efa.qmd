...
```{r}
#| echo: false
aggitems = tibble::tibble(
  item = 1:10,
  wording = c("I hit someone","I kicked someone ","I shoved someone ","I battered someone ","I physically hurt someone on purpose ","I deliberately insulted someone","I swore at someone","I threatened to hurt someone","I called someone a nasty name to their face","I shouted mean things at someone")
)
gt::gt(aggitems)
```
