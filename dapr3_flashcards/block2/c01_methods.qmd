---
title: "Methods for Dimension Reduction, Discovery, and Testing"
format: html
---

The key thing we are doing here is:

1. Start with a set of correlated measured variables
2. Identify a smaller number of dimensions through the capturing of (co)variability across the set of measured variables
