...
#### V: How much **variance** is accounted for by a solution?
...
::: {.callout-tip collapse="true"}
#### I: Are all factors **identified**? Do all factors load on 3+ items at a "salient" level?  
...
::: {.callout-tip collapse="true"}
#### S: Do all items have at least one loading at a **salient** level?  
...
::: {.callout-tip collapse="true"}
#### C: Are there any highly **complex** items, or items with high **cross-loadings**?  
...
::: {.callout-tip collapse="true"}
#### H. Are there any impossible values (**Heywood** cases)?
...
::: {.callout-tip collapse="true"}
#### T: Is the factor structure (items that load on to each factor) **theoretically** coherent? 
