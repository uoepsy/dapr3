---
title: "Checking Suitability for Factor Analysis"
---
...
Most of the correlations are in the range from 0.2 to 0.4. So they aren't hugely strong correlations, but they _are_ all related.  
```{r}
cor(phdat)
```
:::
...
#### Rabbit Hole: What if our variables are not continuous?
...
:::runningeg
For the phone-addiction example, the Bartlett test is significant, meaning that we reject the null hypothesis that our correlation matrix is equivalent to the identity matrix. 
